            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                      ...
                      <a href="tel:+919630971205" className="px-12 py-5 bg-white/5 border border-white/10 text-white font-black rounded-2xl hover:bg-white hover:text-stone-900 transition-all active:scale-95">
                        Talk to Our Experts
                      </a>
                  </div>
                </motion.div>
